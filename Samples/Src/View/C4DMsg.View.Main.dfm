object C4DMsgViewMain: TC4DMsgViewMain
  Left = 0
  Top = 0
  Caption = 'Code4Delphi - Mensagens'
  ClientHeight = 414
  ClientWidth = 508
  Color = clBtnFace
  ...
  object pnBackLogoELinks: TPanel
    ...
    object pnBackLinks: TPanel
      ...
      object lbGitHub: TLabel
        ...
        Height = 31
        Cursor = crHandPoint
        Hint = 'Acessar o GitHub da Code4Delphi'
        Align = alTop
        AutoSize = False
      ...
      object lbTelegram: TLabel
        ...
        Height = 31
        Cursor = crHandPoint
        Hint = 'Acessar grupo do telegram'
        Align = alTop
        AutoSize = False
        Caption = 'https://telegram.me/Code4Delphi'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
        Font.Name = 'Segoe UI'
